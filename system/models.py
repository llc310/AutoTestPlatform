...
class Department(models.Model):
    ...
    description = models.CharField(verbose_name="部门描述", max_length=128, default="公司部门")
    leader = models.ForeignKey(verbose_name="部门领导", to=User, on_delete=models.SET_NULL, null=True,default=None)
...
class Role(models.Model):
    ...
    position = models.ForeignKey(verbose_name="职位",to=Positon,on_delete=models.CASCADE)